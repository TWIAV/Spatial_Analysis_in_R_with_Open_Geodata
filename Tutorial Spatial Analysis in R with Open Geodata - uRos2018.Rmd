...
## Get a description of a dataset: `request=DescribeFeatureType`
...
```
The variable `wfs_fullurl_w_count` will now contain this [link](http://geo.stat.fi/geoserver/vaestoalue/wfs?service=WFS&version=2.0.0&request=GetFeature&typename=vaestoalue:kunta_vaki2017&count=5&outputFormat=application/json). (When you click this link the server response will be shown in your
browser in GeoJSON format.)
