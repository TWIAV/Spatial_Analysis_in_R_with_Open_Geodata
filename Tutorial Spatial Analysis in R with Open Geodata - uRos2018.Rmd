...
Once you have found a nice (and open) dataset in the Living Atlas, you can click to proceed to an overview page with metadata. For the dataset we have chosen - the **Feature Layer** *USA States (Generalized)* - this overview page can be found via this [link](https://www.arcgis.com/home/item.html?id=99fd67933e754a1181cc755146be21ca#overview) (see Figure \ref{USA_States_AGOL_Metadata}). 

In [Map Viewer](https://www.arcgis.com/home/webmap/viewer.html?useExisting=1&layers=99fd67933e754a1181cc755146be21ca)

\newpage

\begin{figure}[H]
\centering
\caption{On the overview page metadata about \textbf{Feature Layer} \textit{USA States (Generalized)} is presented}
\vspace{5pt}
...
url <- parse_url("services.arcgis.com/P3ePLMYs2RVChkJx/arcgis/rest/services/USA_States_Generalized/FeatureServer/0/query?")
url$scheme <- "https"
